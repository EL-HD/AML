...
def mostrar():
    ...
    * 🔴 **Crítico** (Foco en Seguridad): Score_Max >= 8 o Volumen masivo. Requiere reporte a UIF/IVE.
    ...
    * 🟢 **Bajo** (Operación Estándar): Actividad alineada al perfil.
    ...
    4. **Sintonía Fina**: Ajuste pesos y umbrales en *⚙️ Configuración* para reducir falsos positivos según el apetito de riesgo institucional.
