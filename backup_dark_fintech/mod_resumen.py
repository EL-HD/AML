...
def mostrar(df, casos, matriz_alertas):
    ...
    with col_b:
        ...
        bar_colors = ["#ef4444", "#f97316", "#eab308", "#eab308", "#ef4444", "#f97316"]
    ...
    if "TipoOperacion" in df.columns:
        ...
        <div style="background-color: #1b2027; border: 1px solid #f59e0b; border-radius: 0px; padding: 24px; border-left: 8px solid #f59e0b;">
            ...
            <div style="color: #dee2ed; font-size: 14px; line-height: 1.8;">
                ...
                <b style="color: #ef4444;">🛡️ PROTOCOLO DE RIESGO:</b> Detección de anomalías críticas en el canal <b>{canal_riesgoso}</b>. Se requiere monitoreo de transacciones en tiempo real y revisión de EDD.
            </div>
        </div>
        """, unsafe_allow_html=True)
